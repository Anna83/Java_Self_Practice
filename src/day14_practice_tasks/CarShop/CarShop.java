...
import day13_InheritancePractiveTasks.Employee_Task.Teacher;
...
public class CarShop {
    public static void main(String[] args) {
        Car[] cars = {
                new Honda("Plot", "Pilot", 2010, 25000, "White"),
        ...
        for (Car car : cars) {
            ...
            }else if (car instanceof Audi && car.getYear() >= 2015 && car.getYear() >= 2016) {
                System.out.println(car);
