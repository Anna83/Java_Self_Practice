...
public class TipCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Split or No split (Yes or No)?"); // will do if statement at the ent to ask yes or no! // if yes , if no
       ...
       double totalTip = amount * tipRate; // multiply amount of bill with tip rate like 0.20 = total tip 200*0.20
       ...
       scan.close(); // zatvori scan posle zagradice
